                ...
                <div className="div" id="infoContrato">
                    ...
                    <div className="conteudo">
                        ...
                        <div className="divCheckBox">
                            ...
                            <br />
                            <input type="checkbox" className="check" id="avaliacao" defaultChecked={false} value={avaliacao} onChange={(e) => setAvaliacao(e.target.checked ? "Sim" : "Não")} />
                        </div>
                        <div className="divSelect">
                            <label htmlFor="tipo">Tipo</label>
                            <select id="tipo" className="tipo" value={tipo} onChange={(e) => setTipo(e.target.value)}>
                        ...
                        <div className="divCheckBox">
                            ...
                            <br />
                            <input type="checkbox" className="check" id="pend_financeira" defaultChecked={false} value={pendFinanceira} onChange={(e) => setPendFinanceira(e.target.checked ? "Sim" : "Não")} />
                        </div>
                        <div className="divText">
                        ...
                        <div className="divCheckBox">
                            ...
                            <br />
                            <input type="checkbox" className="check" id="contratoAtivo" defaultChecked={false} value={contratoAtivo} onChange={(e) => setContratoAtivo(e.target.checked ? "Sim" : "Não")} />
                        </div>
                    </div>
                </div>
                <br />
                <div className="div" id="infoCliente">
                    ...
                    <div className="conteudo">
                        ...
                        <div className="divSelect">
                            ...
                            <select id="ramo" className="ramo" value={ramoAtividade} onChange={(e) => setRamoAtividade(e.target.value)}>
                                <option value="1">1</option>
                                <option value="2">2</option>
                                <option value="3">3</option>
                                <option value="4">4</option>
                        ...
                        <div className="divSelect">
                            ...
                            <select id="uf" className="uf" value={UF} onChange={(e) => setUF(e.target.value)}>
                ...
                <div className="div" id="infoSistema">
                    ...
                    <div className="conteudo">
                        <div className="divCheckBox">
                            ...
                            <br />
                            <input type="checkbox" className="check" id="ativo" defaultChecked={false} value={ativo} onChange={(e) => setAtivo(e.target.checked ? "Sim" : "Não")} />
                        </div>
                        <div className="divSelect">
                            <label htmlFor="sistema">Sistema</label>
                            <select id="sistema" className="sistema" value={sistema} onChange={(e) => setSistema(e.target.value)}>
                    ...
                    <br />
                    <br />
                    <button type="button" id="editar" className="btn btn-success" onClick={cadastrarCliente}>Salvar</button>
                </div>
            </form>
        </div>
    );
